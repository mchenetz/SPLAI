...
type PrefetchModelRequest struct {
	Model       string   `json:"model"`
	Source      string   `json:"source,omitempty"` // currently: huggingface
...
type PrefetchModelResponse struct {
	JobID           string   `json:"job_id"`
	Model           string   `json:"model"`
	Source          string   `json:"source"`
	TargetedWorkers []string `json:"targeted_workers"`
